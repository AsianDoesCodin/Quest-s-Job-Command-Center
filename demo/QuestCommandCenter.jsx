...
const SEED_JOBS = [
  {
    id: 'j1',
    name: 'Martinez Residence — Reroof',
    address: '4521 E Camelback Rd, Phoenix',
    lat: 33.5092, lng: -111.9831, geofenceMiles: 1,
    type: 'Roofing',
    status: 'active',
    ...
    projectedDays: 3,
    daysElapsed: 2,
    crew: ['Jesus M.', 'Luis R.', 'Pedro A.'],
    foreman: 'Jesus M.',
    contractValue: 18500,
    laborBudget: 4200,
    materialBudget: 8800,
    draws: [
      { id: 'd1', name: 'Deposit', description: 'Signed contract — secures schedule', pct: 50, amount: 9250, status: 'received', date: '2026-04-22', method: 'Check #4892' },
      { id: 'd2', name: 'Final', description: 'Job complete, final walkthrough signed', pct: 50, amount: 9250, status: 'pending', date: null, method: null },
    ],
    dailyBurn: 1420,
    totalBurn: 2840,
    materialStatus: 'delivered',
    notes: 'Owner prefers crew to start 7am sharp. Dogs in backyard.',
    materials: [
      { name: 'GAF Timberline HDZ — Charcoal', qty: '32 sq', status: 'delivered', date: '2026-04-27' },
      { name: 'Synthetic underlayment', qty: '6 rolls', status: 'delivered', date: '2026-04-27' },
      { name: 'Ridge vent — 40ft', qty: '1', status: 'delivered', date: '2026-04-27' },
    ],
  },
  {
    id: 'j2',
    name: 'Johnson Commercial — TPO',
    address: '2200 W Indian School Rd',
    lat: 33.4948, lng: -112.1056, geofenceMiles: 1,
    type: 'Roofing',
    status: 'active',
    ...
    projectedDays: 5,
    daysElapsed: 1,
    crew: ['Carlos H.', 'Miguel S.', 'Roberto T.', 'Diego F.'],
    foreman: 'Carlos H.',
    contractValue: 64200,
    laborBudget: 14500,
    materialBudget: 32800,
    draws: [
      { id: 'd1', name: 'Mobilization', description: 'Contract signed, materials ordered', pct: 25, amount: 16050, status: 'received', date: '2026-04-20', method: 'Wire transfer' },
      { id: 'd2', name: 'Tear-off complete', description: 'Old membrane removed, deck inspection passed', pct: 25, amount: 16050, status: 'requested', date: '2026-04-29', method: 'Submitted via AP portal' },
      { id: 'd3', name: 'Insulation + base', description: 'ISO insulation installed, base sheet down', pct: 25, amount: 16050, status: 'pending', date: null, method: null },
      { id: 'd4', name: 'Final', description: 'TPO membrane complete, final inspection signed', pct: 25, amount: 16050, status: 'pending', date: null, method: null },
    ],
    dailyBurn: 2420,
    totalBurn: 2420,
    materialStatus: 'pending',
    notes: 'Crane access through alley. Coordinate with property mgmt.',
    materials: [
      { name: 'TPO membrane 60mil — white', qty: '85 sq', status: 'in-transit', date: '2026-04-30' },
      { name: 'ISO insulation 2"', qty: '120 boards', status: 'in-transit', date: '2026-04-30' },
      { name: 'Adhesive — bonding', qty: '24 buckets', status: 'delivered', date: '2026-04-28' },
    ],
  },
  {
    id: 'j3',
    name: 'Williams Patio Cover',
    address: '8814 N 32nd Pl',
    lat: 33.5648, lng: -112.0162, geofenceMiles: 1,
    type: 'Construction',
    status: 'active',
    startDate: '2026-04-28',
    endDate: '2026-05-02',
    projectedDays: 5,
    daysElapsed: 1,
    pauseReason: 'Waiting on city inspector for footings',
    expectedResume: '2026-05-01',
    crew: ['Pedro A.', 'Luis R.', 'Roberto T.'],
    foreman: 'Pedro A.',
    contractValue: 12800,
    laborBudget: 3600,
    materialBudget: 5400,
    draws: [
      { id: 'd1', name: 'Deposit', description: 'Permits + materials ordered', pct: 40, amount: 5120, status: 'received', date: '2026-04-25', method: 'Zelle' },
      { id: 'd2', name: 'Footings + framing', description: 'Posts set, beams up, inspector approved', pct: 40, amount: 5120, status: 'pending', date: null, method: null, expectedDate: '2026-05-03' },
      { id: 'd3', name: 'Final', description: 'Cover complete, stain finished, walkthrough', pct: 20, amount: 2560, status: 'pending', date: null, method: null },
    ],
    dailyBurn: 980,
    totalBurn: 540,
    materialStatus: 'ordered',
    notes: 'Permit approved 4/24. HOA notified. Roberto framed posts Mon, paused while waiting on inspector.',
    materials: [
      { name: '6x6 cedar posts', qty: '8', status: 'delivered', date: '2026-04-27' },
      { name: 'Stamped concrete bags', qty: '40', status: 'ordered', date: '2026-05-01' },
    ],
  },
  {
    id: 'j4',
    name: 'Garcia Residence — Reroof',
    address: '1907 W Glendale Ave',
    lat: 33.5384, lng: -112.0962, geofenceMiles: 1,
    type: 'Roofing',
    status: 'scheduled',
    ...
    projectedDays: 3,
    daysElapsed: 0,
    crew: ['Jesus M.', 'Luis R.', 'Miguel S.'],
    foreman: 'Jesus M.',
    contractValue: 21400,
    laborBudget: 4800,
    materialBudget: 9600,
    draws: [
      { id: 'd1', name: 'ACV payment', description: 'Insurance actual cash value released at job start', pct: 60, amount: 12840, status: 'pending', date: null, method: null },
      { id: 'd2', name: 'Recoverable depreciation', description: 'Released after completion + COC sent to carrier', pct: 30, amount: 6420, status: 'pending', date: null, method: null },
      { id: 'd3', name: 'Homeowner deductible', description: 'Customer pays deductible at start', pct: 10, amount: 2140, status: 'pending', date: null, method: null },
    ],
    dailyBurn: 1520,
    totalBurn: 0,
    materialStatus: 'ordered',
    notes: 'Insurance claim — keep all receipts. Adjuster: Tom Reilly.',
    materials: [
      { name: 'Owens Corning Duration — Driftwood', qty: '28 sq', status: 'ordered', date: '2026-05-04' },
      { name: 'Drip edge — bronze', qty: '180 ft', status: 'ordered', date: '2026-05-04' },
    ],
  },
  {
    id: 'j5',
    name: 'Sandoval Garage Build',
    address: '3340 E Thomas Rd',
    lat: 33.4806, lng: -112.0086, geofenceMiles: 1,
    type: 'Construction',
    status: 'scheduled',
    ...
    projectedDays: 12,
    daysElapsed: 0,
    crew: ['Pedro A.', 'Roberto T.', 'Diego F.'],
    foreman: 'Pedro A.',
    contractValue: 48000,
    laborBudget: 16500,
    materialBudget: 22000,
    draws: [
      { id: 'd1', name: 'Deposit', description: 'Contract signed, secures permit + framing materials', pct: 50, amount: 24000, status: 'received', date: '2026-04-15', method: 'Check #1247' },
      { id: 'd2', name: 'Demo + trusses', description: 'Demo of existing slab complete, trusses delivered & set', pct: 30, amount: 14400, status: 'pending', date: null, method: null, expectedDate: '2026-05-05' },
      { id: 'd3', name: 'Final', description: 'Garage complete, final inspection signed, walkthrough done', pct: 20, amount: 9600, status: 'pending', date: null, method: null },
    ],
    dailyBurn: 1850,
    totalBurn: 0,
    materialStatus: 'partial',
    notes: 'Foundation pour scheduled day 2. Concrete truck arrives 6am.',
    materials: [
      { name: 'Lumber package', qty: '1 lot', status: 'ordered', date: '2026-05-08' },
      { name: 'Roof trusses', qty: '14', status: 'pending', date: '2026-05-12' },
    ],
  },
  // UNSCHEDULED — closed sales waiting to be placed on the calendar
  {
    id: 'j6',
    name: 'Patel Residence — Reroof',
    address: '6710 N 14th St',
    lat: 33.5424, lng: -112.0496, geofenceMiles: 1,
    type: 'Roofing',
    ...
    materialBudget: 7200,
    draws: [
      { id: 'd1', name: 'Deposit', pct: 50, amount: 8400, description: 'Signed contract', status: 'received', date: '2026-04-26', method: 'Check #2210' },
      { id: 'd2', name: 'Final', pct: 50, amount: 8400, description: 'Job complete', status: 'pending', date: null, method: null },
    ],
    dailyBurn: 1300,
    totalBurn: 0,
    materialStatus: 'ordered',
    materialsExpectedDate: '2026-05-06',
    notes: 'Customer prefers Wed/Thu start. No work on Saturdays.',
    materials: [
      { name: 'CertainTeed Landmark — Weathered Wood', qty: '26 sq', status: 'ordered', date: '2026-05-06' },
    ],
  },
  {
    id: 'j7',
    name: 'Cedar Hills HOA — 4 buildings',
    address: '2400 W Cedar Hills Dr',
    lat: 33.5811, lng: -112.0712, geofenceMiles: 1,
    type: 'Roofing',
    status: 'pending-schedule',
    startDate: null,
    endDate: null,
    ...
    contractValue: 92500,
    laborBudget: 22000,
    materialBudget: 48000,
    draws: [
      { id: 'd1', name: 'Mobilization', pct: 30, amount: 27750, description: 'Materials staged on site', status: 'pending', date: null, method: null },
      { id: 'd2', name: 'Buildings 1-2 complete', pct: 35, amount: 32375, description: 'First two buildings done, HOA walk', status: 'pending', date: null, method: null },
      { id: 'd3', name: 'Final', pct: 35, amount: 32375, description: 'All four buildings done', status: 'pending', date: null, method: null },
    ],
    dailyBurn: 2800,
    totalBurn: 0,
    materialStatus: 'ordered',
    materialsExpectedDate: '2026-05-11',
    notes: 'HOA wants minimal disruption — start with farthest building from clubhouse.',
    materials: [
      { name: 'GAF Timberline UHDZ — Slate', qty: '120 sq', status: 'ordered', date: '2026-05-11' },
    ],
  },
  {
    id: 'j8',
    name: 'Romero Kitchen Addition',
    address: '5512 E Sweetwater Ave',
    lat: 33.6128, lng: -111.9712, geofenceMiles: 1,
    type: 'Construction',
    status: 'pending-schedule',
    startDate: null,
    endDate: null,
    projectedDays: 14,
    daysElapsed: 0,
    crew: ['Pedro A.', 'Roberto T.'],
    foreman: 'Pedro A.',
    contractValue: 38500,
    laborBudget: 14000,
    materialBudget: 18000,
    draws: [
      { id: 'd1', name: 'Deposit', pct: 35, amount: 13475, description: 'Permit submitted, materials ordered', status: 'received', date: '2026-04-24', method: 'Wire' },
      { id: 'd2', name: 'Framing complete', pct: 35, amount: 13475, description: 'Framing inspection passed', status: 'pending', date: null, method: null },
      { id: 'd3', name: 'Final', pct: 30, amount: 11550, description: 'Final inspection + walkthrough', status: 'pending', date: null, method: null },
    ],
    dailyBurn: 1100,
    totalBurn: 0,
    materialStatus: 'pending',
    materialsExpectedDate: '2026-05-18',
    notes: 'Permit pending city review. Earliest start mid-May.',
    materials: [
      { name: 'Cabinet boxes', qty: '12 lf', status: 'pending', date: '2026-05-18' },
    ],
  },
  // COMPLETED JOBS — historical, used by the Completed tab
  {
    id: 'jh1',
    name: 'Hernandez Residence — Reroof',
    address: '1418 W Glendale Ave, Phoenix',
    lat: 33.5384, lng: -112.0962, geofenceMiles: 1,
    type: 'Roofing',
    status: 'complete',
    ...
    laborBudget: 3800,
    materialBudget: 7200,
    actualLaborCost: 3640,
    materialStatus: 'delivered',
    notes: 'Smooth job. Customer referred us to neighbor.',
    materials: [{ name: 'GAF Timberline — 28 sq · Aged Bronze', qty: '28 sq', status: 'delivered', date: '2026-03-12' }],
    draws: [
      { id: 'd1', name: 'Deposit', pct: 50, amount: 8100, description: 'Signed contract', status: 'received', date: '2026-03-09', method: 'Check #4101' },
      { id: 'd2', name: 'Final', pct: 50, amount: 8100, description: 'Job complete', status: 'received', date: '2026-03-16', method: 'Check #4128' },
    ],
  },
  {
    id: 'jh2',
    name: 'Vista Plaza — Commercial TPO',
    address: '5800 N 19th Ave, Phoenix',
    lat: 33.5292, lng: -112.0966, geofenceMiles: 1,
    type: 'Roofing',
    status: 'complete',
    ...
    contractValue: 78400,
    laborBudget: 18000,
    materialBudget: 35000,
    actualLaborCost: 19440,
    materialStatus: 'delivered',
    notes: 'Came in 1 day over. Crane rental added cost.',
    materials: [{ name: 'TPO membrane + insulation', qty: '95 sq', status: 'delivered', date: '2026-02-22' }],
    draws: [
      { id: 'd1', name: 'Mobilization', pct: 30, amount: 23520, description: 'Materials staged', status: 'received', date: '2026-02-20', method: 'Wire' },
      { id: 'd2', name: 'Tear-off + insulation', pct: 35, amount: 27440, description: 'Substrate ready', status: 'received', date: '2026-02-28', method: 'Wire' },
      { id: 'd3', name: 'Final', pct: 35, amount: 27440, description: 'TPO + final inspection', status: 'received', date: '2026-03-08', method: 'Wire' },
    ],
  },
  {
    id: 'jh3',
    name: 'Brown Residence — Reroof',
    address: '6240 E Earll Dr, Scottsdale',
    lat: 33.5012, lng: -111.9534, geofenceMiles: 1,
    type: 'Roofing',
    status: 'complete',
    ...
    laborBudget: 3400,
    materialBudget: 6500,
    actualLaborCost: 3220,
    materialStatus: 'delivered',
    notes: 'Quick turnaround. Insurance job — final docs sent to State Farm.',
    materials: [{ name: 'CertainTeed Landmark — 24 sq', qty: '24 sq', status: 'delivered', date: '2026-04-05' }],
    draws: [
      { id: 'd1', name: 'ACV', pct: 60, amount: 8880, description: 'Insurance ACV', status: 'received', date: '2026-04-02', method: 'Check' },
      { id: 'd2', name: 'Recoverable depreciation', pct: 30, amount: 4440, description: 'After COC sent', status: 'received', date: '2026-04-15', method: 'Check' },
      { id: 'd3', name: 'Deductible', pct: 10, amount: 1480, description: 'Customer paid', status: 'received', date: '2026-04-06', method: 'Cash' },
    ],
  },
];

const SEED_TEAM = [
  { id: 't1', name: 'Jesus M.', role: 'Foreman / Roofing', payType: 'daily', payAmount: 280, initials: 'JM', color: '#ED4E0D' },
  { id: 't2', name: 'Carlos H.', role: 'Foreman / Commercial', payType: 'salary', payAmount: 1200, initials: 'CH', color: '#60a5fa' },
  { id: 't3', name: 'Pedro A.', role: 'Foreman / Construction', payType: 'daily', payAmount: 260, initials: 'PA', color: '#4ade80' },
  { id: 't4', name: 'Luis R.', role: 'Roofer', payType: 'hourly', payAmount: 28, initials: 'LR', color: '#a78bfa' },
  { id: 't5', name: 'Miguel S.', role: 'Roofer', payType: 'hourly', payAmount: 26, initials: 'MS', color: '#f472b6' },
  { id: 't6', name: 'Roberto T.', role: 'Carpenter', payType: 'daily', payAmount: 240, initials: 'RT', color: '#fb923c' },
  { id: 't7', name: 'Diego F.', role: 'Helper', payType: 'hourly', payAmount: 22, initials: 'DF', color: '#34d399' },
  { id: 't8', name: 'Maria L.', role: 'Office Manager', payType: 'salary', payAmount: 1100, initials: 'ML', color: '#facc15' },
];
...
const SEED_TIMELOG = [
  { id: 'tl1', worker: 'Jesus M.', jobId: 'j1', date: '2026-04-28', clockIn: '6:58 AM', clockOut: '3:58 PM', hours: 9, role: 'Foreman', verified: true, distance: 0.04 },
  { id: 'tl2', worker: 'Luis R.', jobId: 'j1', date: '2026-04-28', clockIn: '7:02 AM', clockOut: '4:02 PM', hours: 9, role: 'Roofer', verified: true, distance: 0.06 },
  { id: 'tl3', worker: 'Pedro A.', jobId: 'j1', date: '2026-04-28', clockIn: '7:15 AM', clockOut: '3:15 PM', hours: 8, role: 'Helper', verified: true, distance: 0.11 },
  { id: 'tl4', worker: 'Jesus M.', jobId: 'j1', date: '2026-04-29', clockIn: '7:00 AM', clockOut: null, hours: 8, role: 'Foreman', verified: true, distance: 0.05 },
  { id: 'tl5', worker: 'Luis R.', jobId: 'j1', date: '2026-04-29', clockIn: '7:08 AM', clockOut: null, hours: 8, role: 'Roofer', verified: true, distance: 0.09 },
  { id: 'tl6', worker: 'Pedro A.', jobId: 'j1', date: '2026-04-29', clockIn: '8:42 AM', clockOut: null, hours: 8, role: 'Helper', verified: false, distance: 1.34, flagReason: 'Outside 1-mile geofence' },
  { id: 'tl7', worker: 'Carlos H.', jobId: 'j2', date: '2026-04-29', clockIn: '6:45 AM', clockOut: null, hours: 9, role: 'Foreman', verified: true, distance: 0.02 },
  { id: 'tl8', worker: 'Miguel S.', jobId: 'j2', date: '2026-04-29', clockIn: '6:55 AM', clockOut: null, hours: 9, role: 'Roofer', verified: true, distance: 0.08 },
  { id: 'tl9', worker: 'Roberto T.', jobId: 'j2', date: '2026-04-29', clockIn: '7:01 AM', clockOut: null, hours: 9, role: 'Carpenter', verified: true, distance: 0.12 },
  { id: 'tl10', worker: 'Diego F.', jobId: 'j2', date: '2026-04-29', clockIn: '7:05 AM', clockOut: null, hours: 9, role: 'Helper', verified: true, distance: 0.18 },
  // Multi-job day — Roberto hit two jobs on 4/28 (daily rate worker)
  { id: 'tl11', worker: 'Roberto T.', jobId: 'j1', date: '2026-04-28', clockIn: '7:00 AM', clockOut: '11:30 AM', hours: 4.5, role: 'Carpenter', verified: true, distance: 0.07 },
  { id: 'tl12', worker: 'Roberto T.', jobId: 'j3', date: '2026-04-28', clockIn: '12:00 PM', clockOut: '4:30 PM', hours: 4.5, role: 'Carpenter', verified: true, distance: 0.11 },
];

const SEED_EXPENSES = [
  // Active job expenses
  {
    id: 'e1', date: '2026-04-27', vendor: 'ABC Supply Co.', total: 4280.50,
    items: [
      { description: 'GAF Timberline HDZ Charcoal — 32 sq', amount: 3520.00 },
      { description: 'Synthetic underlayment — 6 rolls', amount: 612.00 },
      { description: 'Roofing nails — 5 boxes', amount: 148.50 },
    ],
    allocations: [{ jobId: 'j1', amount: 4280.50 }],
    paidBy: 'Abraham', paymentMethod: 'credit-account',
    receiptUrl: null, notes: 'Picked up Monday morning',
  },
  {
    id: 'e2', date: '2026-04-28', vendor: 'Home Depot — 24th St', total: 387.62,
    items: [
      { description: 'Drip edge bronze 10ft — 18 pcs', amount: 124.20 },
      { description: 'Construction screws 3" — 5 lb', amount: 89.50 },
      { description: 'Tarp 20x30 — 2 ea', amount: 79.92 },
      { description: '6x6 cedar post 8ft — 2 ea', amount: 94.00 },
    ],
    allocations: [{ jobId: 'j1', amount: 213.70 }, { jobId: 'j3', amount: 173.92 }],
    paidBy: 'Abraham', paymentMethod: 'cod-card',
    receiptUrl: null, notes: 'Two jobs split — ask Maria to verify',
  },
  {
    id: 'e3', date: '2026-04-29', vendor: 'GMS — Phoenix', total: 1840.00,
    items: [
      { description: 'TPO adhesive bonding — 24 buckets', amount: 1680.00 },
      { description: 'Termination bar — 60 ft', amount: 160.00 },
    ],
    allocations: [{ jobId: 'j2', amount: 1840.00 }],
    paidBy: 'Carlos H.', paymentMethod: 'credit-account',
    receiptUrl: null, notes: '',
  },
  // Historical expenses tied to completed jobs (for the Completed tab P&L)
  {
    id: 'e4', date: '2026-03-12', vendor: 'ABC Supply Co.', total: 6240.00,
    items: [{ description: 'GAF Timberline — 28 sq · Aged Bronze', amount: 6240.00 }],
    allocations: [{ jobId: 'jh1', amount: 6240.00 }],
    paidBy: 'Abraham', paymentMethod: 'credit-account',
    receiptUrl: null, notes: '',
  },
  {
    id: 'e5', date: '2026-03-14', vendor: 'Home Depot — 24th St', total: 312.40,
    items: [{ description: 'Misc. fasteners + sealant', amount: 312.40 }],
    allocations: [{ jobId: 'jh1', amount: 312.40 }],
    paidBy: 'Jesus M.', paymentMethod: 'cod-cash',
    receiptUrl: null, notes: '',
  },
  {
    id: 'e6', date: '2026-02-22', vendor: 'GMS — Phoenix', total: 28400.00,
    items: [{ description: 'TPO membrane + insulation package', amount: 28400.00 }],
    allocations: [{ jobId: 'jh2', amount: 28400.00 }],
    paidBy: 'Abraham', paymentMethod: 'credit-account',
    receiptUrl: null, notes: '',
  },
  {
    id: 'e7', date: '2026-02-25', vendor: 'Sunstate Equipment', total: 1850.00,
    items: [{ description: 'Crane rental — 2 days', amount: 1850.00 }],
    allocations: [{ jobId: 'jh2', amount: 1850.00 }],
    paidBy: 'Abraham', paymentMethod: 'cod-card',
    receiptUrl: null, notes: 'Equipment rental — invoice 88291',
  },
  {
    id: 'e8', date: '2026-04-05', vendor: 'ABC Supply Co.', total: 5180.00,
    items: [{ description: 'CertainTeed Landmark — 24 sq', amount: 5180.00 }],
    allocations: [{ jobId: 'jh3', amount: 5180.00 }],
    paidBy: 'Abraham', paymentMethod: 'credit-account',
    receiptUrl: null, notes: '',
  },
  {
    id: 'e9', date: '2026-04-08', vendor: 'Home Depot — 24th St', total: 96.18,
    items: [{ description: 'Roof cement + flashing', amount: 96.18 }],
    allocations: [{ jobId: 'jh3', amount: 96.18 }],
    paidBy: 'Jesus M.', paymentMethod: 'cod-cash',
    receiptUrl: null, notes: '',
  },
];
...
const SEED_MESSAGES = [
  { id: 'm1', author: 'Jesus M.', initials: 'JM', text: 'Martinez tear-off done. Decking looks solid, no rot.', time: '7:42 AM', date: '2026-04-29', jobId: 'j1' },
  { id: 'm2', author: 'Abraham', initials: 'AB', text: 'Good. Send pic of north slope before underlayment.', time: '7:48 AM', date: '2026-04-29', jobId: 'j1' },
  { id: 'm3', author: 'Carlos H.', initials: 'CH', text: 'Got to Johnson site. Property mgr wants the dumpster moved 10ft north.', time: '6:55 AM', date: '2026-04-29', jobId: 'j2' },
  { id: 'm4', author: 'Maria L.', initials: 'ML', text: 'Williams permit came back signed. Filed copy in drive.', time: '9:12 AM', date: '2026-04-29', jobId: null },
  { id: 'm5', author: 'Jesus M.', initials: 'JM', text: 'Need 2 more bundles delivered tomorrow if we keep this pace.', time: '11:30 AM', date: '2026-04-29', jobId: 'j1' },
];
    ...
    <div style={{ minHeight: '100vh', background: T.bg, color: T.text, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, fontFamily: "'Helvetica Neue', Arial, sans-serif" }}>
      <div style={{ maxWidth: 480, width: '100%' }}>
        ...
        <div style={{ fontSize: 12, color: T.textMute, marginTop: 18, textAlign: 'center', letterSpacing: 1 }}>
          DEMO MODE — TAP A ROLE TO PREVIEW WHAT THEY SEE
        </div>
      </div>
    </div>
  );
...
export default function QuestApp() {
  ...
  const [timelog, setTimelog] = useState(SEED_TIMELOG);
